...
CASEPATTERN = r"Full.tower|Mid.tower|Micro.tower|Mini.tower|Micro.atx|Mini.atx|atx|tempered.glass"
CPUPATTERN =  r"celeron.\w+|i3|i5|i7|core.\d.duo|core.\d.quad|\d.\d.Ghz|LGA.\d{3,4}|\d{2,4}w|\w+.core|\d\d?...gen|\w+.lake|\d.\dghz|turbo.boost|ryzen.\d|\d{4}x?|\w+.boost|\w+.lake|\d{1,3}mm|cooler|desktop|\w\w\d{3}|cpu.fan|core.i\d.\d{4,5}\w?|\w+.\w+.graphics|socket.\w+|zen.\d|..series|CPU.\w+.fan|for.\w+|rgb"
...
HDDPATTERN = r"\d{1,6}Gb.s|\d{1,6}Gb|rpm|\d{1,6}mb.s|\d{1,6}mb|cache|\d{1,6}tb.s|\d{1,6}tb"
